...
class MainActivity(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val models = listOf(
            Downloadable(
                "Qwen2-0.5B (0.349 GB)",
                Uri.parse("https://huggingface.co/eziyo/Qwen2-0.5B-Instruct-IQ4_XS-GGUF/resolve/main/qwen2-0.5b-instruct-iq4_xs-imat.gguf?download=true"),
                File(extFilesDir, "qwen2.5-7b-instruct-q4_k_m-00001-of-00002.gguf")
            ),
            Downloadable(
                "Qwen2.5-1.5b (1.12 GB)",
