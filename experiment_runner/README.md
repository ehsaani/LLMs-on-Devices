...
> **Note:** This repository contains the experimental pipeline and configuration scripts for the Master's Thesis: *"Green Mobile Intelligence: Quantifying Energy Accuracy Trade-Offs in On-Device Large Language Models"* at the University of Naples Federico II.
...
## 🎓 Author
**Mohammad (Eziyo) Ehsani**
* Master's Candidate in Data Science, University of Naples Federico II
* [LinkedIn] (https://www.linkedin.com/in/eziyo/)

**Supervisors:** Prof. Roberto Pietrantuono & Prof. Ivano Malavolta